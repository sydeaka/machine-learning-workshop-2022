...
-   An opportunity to use popular ML tools on real datasets for clinical and pre-clinical use-cases​
...
-   If interested in learning about more advanced ML use cases, I invite you to attend the upcoming AADS AI / ML workshop (contact Haoda Fu for details)​

## Machine learning defined

There are many ways to define Machine Learning, but here's a good one: ![](images/ML_defined_by_MS.png)
...
::: footer
https://towardsdatascience.com/how-is-machine-learning-different-from-statistics-and-why-it-matters-5a8ed539976
:::
...
![](images/ML_algorithm_overview.png)
...
tm <- system.time({
  xgb_res <-
    ...
    tune_grid(resamples = dat_folds, 
              grid = xgb_param %>% grid_max_entropy(size = 5),
              control = ctrl)
})
