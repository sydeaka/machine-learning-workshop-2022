...
model_name <- glue::glue("actg175_demo_{selected_outcome}_model_predict")
...
# This line is commented out due to a conflict between the package managers
# But normally we would uncomment and run the following line
...
```{bash}
curl -X POST "https://rstudio-connect.am.lilly.com/content/a4d4bf54-dbaa-4f58-af21-d0fba64416f0/predict" \
